...
<body>
    ...
    @section('content')
    <div class="mt-16">
        <p class="text-4xl lg:text-5xl  font-serif ">Create Plan</p>
        <a href="{{route('plans.index')}}" class="text-2xl lg:text-4xl  font-serif text-blue-700 hover:text-blue-400 ">view plans</a>
    </div>
