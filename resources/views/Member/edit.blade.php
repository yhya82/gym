...
@section('content')
    <div class="mt-10">
        <p class="text-4xl lg:text-6xl font-serif">Update Member</p>
    </div>
     <form id="form-data" class="px-4">
        ...
        <button type="submit" class="bg-blue-900 text-white text-2xl lg:text-4xl font-bold p-2 lg:p-4 rounded-2xl w-1/4 hover:bg-blue-500" > Update Memeber</button>
        </div>
    </form>
    @endsection
