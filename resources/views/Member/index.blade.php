    ...
    <a href="{{route('members.create')}}" class="text-2xl lg:text-3xl text-blue-600 hover:text-blue-400">Create new member</a>
    </div>
    <div class="px-2">
        <input type="search" id="searchInput" class="w-1/2 lg:w-1/4">
    ...
    <div class="overflow-x-auto mt-4 lg:mt-6 px-2">
